...
const modules = ["financeiro", "produtos", "moeda", "dashboard", "aparencia", "assets", "ofertas", "afiliados", "payout", "vendas", "assinaturas", "plano", "integracoes", "cupons", "relatorios", "colaboradores", "ajuda"];
