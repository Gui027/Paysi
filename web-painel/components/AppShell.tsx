...
const links = [["/inicio", "Início"], ["/produtos", "Produtos"], ["/vendas", "Vendas"], ["/assinaturas", "Assinaturas"], ["/afiliados", "Afiliados"], ["/vitrine", "Vitrine"], ["/meus-links", "Meus links"], ["/saldo", "Saldo"], ["/plano", "Plano"], ["/componentes", "Componentes"]] as const;
