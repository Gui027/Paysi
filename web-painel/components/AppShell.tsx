...
const links = [["/inicio", "Início"], ["/produtos", "Produtos"], ["/vendas", "Vendas"], ["/assinaturas", "Assinaturas"], ["/afiliados", "Afiliados"], ["/vitrine", "Vitrine"], ["/meus-links", "Meus links"], ["/saldo", "Saldo"], ["/plano", "Plano"], ["/integracoes", "Integrações"], ["/verificacao", "Verificação"], ["/perfil", "Perfil"], ["/componentes", "Componentes"]] as const;
